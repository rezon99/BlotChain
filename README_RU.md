...
- ✅ **Аналитика и Графики:** Интеграция мини-графиков (Sparklines) в Tooltip и панель сравнения для отслеживания 7-дневных трендов.

### 📋 Планируется (Бэклог)
1. **Аналитика и Графики:**
   - Детальный график истории цены при клике на актив (используя уже готовый метод `getCoinHistory`).
...
3. **Интерактивность:**
   - Возможность перетаскивания (Drag-and-drop) узлов для ручной компоновки графа.
